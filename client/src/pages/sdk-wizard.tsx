...
const applicationTypeOptions = [
  {
    ...
    description: "Browser-based applications with client-server architecture",
  },
  {
    id: "mobile",
    name: "Mobile Application",
    description: "Native or hybrid mobile apps for iOS/Android",
  },
  {
    id: "desktop",
    name: "Desktop Application",
    description: "Native desktop applications for Windows/Mac/Linux",
  },
  {
    id: "api",
  ...
  },
  {
    ...
    description: "Video calling and conferencing applications",
  },
  {
    id: "messaging",
    name: "Chat/Messaging",
    description: "Real-time messaging and communication apps",
  },
  {
    id: "social",
    name: "Social Media",
  ...
  },
  {
    ...
    description: "Video/audio streaming and media platforms",
  },
  {
    id: "ecommerce",
    name: "E-commerce",
  ...
  },
  {
    ...
    description: "Cryptocurrency and blockchain applications",
  },
];
...
const dataTypes = [
  {
    ...
    description: "Names, addresses, contact details",
  },
  {
    id: "financial",
    name: "Financial Data",
    description: "Payment information, banking records",
  },
  {
    id: "medical",
    name: "Medical Records",
    description: "Healthcare and patient information",
  },
  {
    id: "business",
    name: "Business Data",
  ...
  },
  {
    ...
    description: "Classified or sensitive government data",
  },
  {
    id: "biometric",
    name: "Biometric Data",
    description: "Fingerprints, facial recognition, DNA",
  },
  {
    id: "location",
    name: "Location Data",
    description: "GPS coordinates, tracking information",
  },
  {
    id: "communication",
    name: "Communications",
    description: "Messages, emails, call records",
  },
  {
    id: "behavioral",
  ...
  },
  {
    ...
    description: "Patents, trade secrets, research data",
  },
];
...
const dataTypeOptions = [
  {
    id: "personal",
    name: "Personal Data",
    description: "User profiles, contact information, PII",
  },
  {
    id: "financial",
    name: "Financial Data",
    description: "Payment info, transactions, banking records",
  },
  {
    id: "medical",
    name: "Medical Records",
    description: "Health information, patient data, PHI",
  },
  {
    id: "business",
    name: "Business Data",
    description: "Corporate documents, trade secrets, IP",
  },
  {
    id: "communications",
    name: "Communications",
    description: "Messages, emails, chat logs, calls",
  },
  {
    id: "files",
    name: "File Storage",
    description: "Documents, images, media files, attachments",
  },
  {
    id: "authentication",
    name: "Authentication",
    description: "Passwords, tokens, credentials, sessions",
  },
  {
    id: "biometric",
    name: "Biometric Data",
  ...
  },
  {
    id: "location",
    name: "Location Data",
    description: "GPS coordinates, geolocation, tracking data",
  },
  {
    id: "analytics",
    name: "Analytics/Metrics",
    description: "User behavior, performance data, statistics",
  },
  {
    id: "media",
    name: "Media Content",
    description: "Videos, audio, images, streaming content",
  },
  {
    id: "social",
    name: "Social Data",
    description: "Posts, likes, connections, social graphs",
  },
  {
    id: "iot",
    name: "IoT/Sensor Data",
    description: "Device data, sensor readings, telemetry",
  },
  {
    id: "blockchain",
    name: "Blockchain/Crypto",
    description: "Wallet data, transactions, smart contracts",
  },
];
...
const deploymentEnvironments = [
  {
    ...
    description: "Public cloud environments",
  },
  {
    id: "onpremise",
    name: "On-Premise",
    description: "Private data centers and servers",
  },
  {
    id: "hybrid",
    name: "Hybrid Cloud",
  ...
  },
  {
    id: "edge",
    name: "Edge Computing",
    description: "Edge devices and distributed computing",
  },
  {
    id: "tee-cloud",
    name: "TEE Cloud (Confidential VMs)",
    description: "Cloud with trusted execution environments",
  },
  {
    id: "sgx-enclave",
    name: "Intel SGX Enclave",
    description: "Hardware-based trusted execution environments",
  },
  {
    id: "sev-secure",
    name: "AMD SEV Secure Memory",
    description: "Secure encrypted virtualization environments",
  },
];
...
const complianceStandards = [
  ...
  },
  {
    id: "fips140-2",
    name: "FIPS 140-2",
    description: "US government cryptographic standards (legacy)",
  },
  {
    id: "fips140-3",
    name: "FIPS 140-3",
    description: "Latest US government cryptographic standards",
  },
  {
    id: "nist-pqc",
    name: "NIST PQC",
    description: "Post-quantum cryptography standards (FIPS 203/204/205)",
  },
  {
    id: "nsa-cnsa-2.0",
    name: "NSA CNSA 2.0",
    description: "Post-quantum ready security requirements",
  },
  {
    id: "iso27001",
    name: "ISO 27001",
  ...
  },
  {
    id: "fedramp",
    name: "FedRAMP",
    description: "US federal cloud security standards",
  },
  {
    id: "cccs",
    name: "Common Criteria",
    description: "International IT security evaluation standards",
  },
  {
    id: "suite-b",
    name: "NSA Suite B",
    description: "Government cryptographic algorithm suite (transitioning)",
  },
];
...
const securityLevels = [
  {
    ...
    description: "Basic encryption for general use cases (AES-256-GCM)",
  },
  {
    id: "enhanced",
    name: "Enhanced Security",
    description: "Strong encryption for sensitive data (FIPS 140-3 validated)",
  },
  {
    id: "maximum",
    name: "Maximum Security",
    description: "Military-grade encryption for critical systems (Suite B)",
  },
  {
    id: "quantum_ready",
    name: "Quantum-Ready",
    description: "Hybrid classical+PQC algorithms for future protection",
  },
  {
    id: "post_quantum",
    name: "Post-Quantum",
    description: "Pure PQC algorithms (ML-KEM, ML-DSA, SPHINCS+)",
  },
  {
    id: "confidential",
    name: "Confidential Computing",
    description: "TEE-based protection with encrypted computation",
  },
  {
...
const confidentialComputingFeatures = [
  ...
  {
    id: "homomorphicEncryption",
    name: "Homomorphic Encryption",
    description: "Compute on encrypted data without decryption",
  },
  {
    id: "multiPartyComputation",
    name: "Multi-Party Computation",
    description: "Joint computation without revealing private inputs",
  },
  {
    id: "zeroKnowledgeProofs",
    name: "Zero-Knowledge Proofs",
    description: "Prove knowledge without revealing the information",
  },
  {
    id: "differentialPrivacy",
    name: "Differential Privacy",
    description: "Privacy-preserving data analytics",
  },
  {
    id: "secureAggregation",
    name: "Secure Aggregation",
    description: "Aggregate data without exposing individual inputs",
  },
];
...
const features = [
  {
    ...
    description: "Intelligent key rotation with zero downtime",
  },
  {
    id: "selfHealing",
    name: "Self-Healing Security",
    description: "AI-powered threat detection and auto-response",
  },
  {
    id: "zeroKnowledge",
    name: "Zero-Knowledge Architecture",
    description: "Complete server-side blindness to your data",
  },
  {
    id: "telemetry",
    name: "Real-time Telemetry",
    description: "Advanced monitoring with predictive analytics",
  },
  {
    id: "multiTenant",
    name: "Multi-Tenant Isolation",
    description: "Enterprise-grade tenant segregation",
  },
  {
    id: "backup",
    name: "Distributed Backup",
    description: "Quantum-resistant backup with instant recovery",
  },
  {
    id: "autoInstall",
    name: "Zero-Config Installation",
    description: "One-command setup with auto-dependency management",
  },
  {
    id: "adaptiveEncryption",
    name: "Adaptive Encryption",
    description: "Dynamic algorithm selection based on threat level",
  },
  {
    id: "quantumShield",
    name: "Quantum Shield",
    description: "Future-proof protection against quantum attacks",
  },
  {
  ...
  },
  {
    id: "teeProtection",
    name: "TEE Protection",
    description: "Hardware-based secure enclaves for sensitive computation",
  },
  {
    id: "homomorphicCompute",
    name: "Homomorphic Computing",
    description: "Encrypted computation capabilities",
  },
  {
    id: "secureMPC",
    name: "Secure MPC",
    description: "Multi-party computation protocols",
  },
  {
    id: "attestationVerify",
    name: "Remote Attestation",
    description: "Verify trusted execution environment integrity",
  },
];
...
export default function SdkWizard() {
  ...
  const [applicationTypes, setApplicationTypes] = useState<string[]>(
    applicationTypeOptions.map((type) => type.id)
  );
  const [deploymentEnvironment, setDeploymentEnvironment] = useState("");
  const [complianceRequirements, setComplianceRequirements] = useState<
    string[]
  >(complianceStandards.map((standard) => standard.id));
  ...
  const [confidentialFeatures, setConfidentialFeatures] = useState<string[]>(
    confidentialComputingFeatures.map((feature) => feature.id)
  );
  const [dataTypesSelected, setDataTypesSelected] = useState<string[]>(
    dataTypeOptions.map((dataType) => dataType.id)
  );
  const [recommendedAlgorithms, setRecommendedAlgorithms] = useState<
    EncryptionAlgorithm[]
  >([]);
  const [generatedSDK, setGeneratedSDK] = useState<any>(null);
  const [complianceRecommendation, setComplianceRecommendation] =
    useState<any>(null);
  ...
  // Pre-select algorithms when step 4 is reached or when algorithms are loaded
  useEffect(() => {
    if (step === 4 && Array.isArray(algorithms) && algorithms.length > 0) {
      ...
      console.log(
        "Pre-selecting ALL algorithms. Total:",
        allAlgorithmIds.length
      );
      setSelectedAlgorithms(allAlgorithmIds);

      // Also log recommendations for reference
      if (
        Array.isArray(recommendedAlgorithms) &&
        recommendedAlgorithms.length > 0
      ) {
        const recommendedIds = recommendedAlgorithms.map(
          (alg: EncryptionAlgorithm) => alg.id
        );
        console.log("Recommended subset:", recommendedIds);
      }
    }
  }, [step, algorithms]);
  ...
  const getNextStep = (currentStep: number) => {
    ...
    if (
      currentStep === 2 &&
      securityLevel &&
      ["confidential", "privacy_preserving"].includes(securityLevel)
    ) {
  ...
  const handleNext = () => {
    ...
    if (step === 2 && dataTypesSelected.length === 0) {
      toast({
        title: "Missing Information",
        description:
          "Please select at least one type of data you'll be encrypting.",
        variant: "destructive",
      });
      return;
    }
  ...
  const handleGenerateSDK = () => {
    ...
    const unifiedSDK = {
      ...
      algorithms:
        selectedAlgorithms.length > 0
          ? selectedAlgorithms
          : recommendedAlgorithms.map((alg) => alg.id), // Array of selected algorithms
      ...
      configuration: {
        ...
        quantumSafe: selectedAlgorithms.some(
          (id) =>
            Array.isArray(algorithms) &&
            algorithms.find((alg: EncryptionAlgorithm) => alg.id === id)
              ?.isPostQuantum
        ),
      ...
      <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-7 gap-4">
            {[
              ...
              <div key={num} className="flex flex-col items-center text-center">
                ...
                {index < 6 && (
                  <div className="hidden md:block w-full h-px bg-border mt-2 absolute translate-x-12"></div>
                )}
              </div>
            ))}
          </div>
        ...
        <Card className="bg-card border-border">
          ...
          <CardContent className="p-8">
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm mb-4">
                    <span className="font-medium text-blue-600 dark:text-blue-400">
                      ✓ All options pre-selected for convenience.
                    </span>{" "}
                    Uncheck any types that don't apply to your system.
                  </p>
                    ...
                    {applicationTypeOptions.map((type) => (
                      ...
                      >
                        <Checkbox
                          ...
                          onCheckedChange={() =>
                            handleApplicationTypeToggle(type.id)
                          }
                ...
                <div>
                  ...
                  <RadioGroup
                    ...
                    onValueChange={setDeploymentEnvironment}
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            {step === 2 && (
              <div className="space-y-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-muted-foreground text-sm">
                    What kind of data will you be encrypting?
                  </p>
                </div>
                ...
                <div>
                  <Label className="text-foreground font-medium mb-4 block">
                    Data Types You'll Encrypt *
                  </Label>
                  <p className="text-muted-foreground text-sm mb-3">
                    <span className="font-medium text-blue-600 dark:text-blue-400">
                      ✓ All data types pre-selected.
                    </span>{" "}
                    Uncheck any types you won't be encrypting.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm mb-3">
                    <span className="font-medium text-blue-600 dark:text-blue-400">
                      ✓ All standards pre-selected.
                    </span>{" "}
                    Uncheck any that don't apply to your requirements.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {complianceStandards.map((standard) => (
                      ...
                      >
                        <Checkbox
                          ...
                          onCheckedChange={() =>
                            handleComplianceToggle(standard.id)
                          }
                          className="border-border"
                        />
                        <div>
                    ...
                    <div className="space-y-4">
                      <div className="flex flex-wrap items-center gap-2">
                        <Badge variant="secondary" className="font-medium">
                          Recommended:{" "}
                          {complianceRecommendation.recommendedProfile?.replace(
                            /_/g,
                            " "
                          )}
                        </Badge>
                        <Badge
                          variant={
                            complianceRecommendation.urgency === "critical"
                              ? "destructive"
                              : complianceRecommendation.urgency === "high"
                              ? "destructive"
                              : complianceRecommendation.urgency === "medium"
                              ? "default"
                              : "secondary"
                          }
                        >
                      ...
                      <p className="text-muted-foreground text-sm">
                        ...
                        {complianceRecommendation.rationale}
                      </p>
                      ...
                      {complianceRecommendation.profile && (
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-2">
                          <div className="text-center">
                            ...
                            <Badge
                              variant={
                                complianceRecommendation.profile.fipsRequired
                                  ? "default"
                                  : "secondary"
                              }
                            >
                          ...
                          <div className="text-center">
                            ...
                            <Badge
                              variant={
                                complianceRecommendation.profile.quantumSafe
                                  ? "default"
                                  : "secondary"
                              }
                            >
                          ...
                          <div className="text-center">
                            ...
                            <Badge variant="outline">
                              {complianceRecommendation.profile.level}
                            </Badge>
                          </div>
                          <div className="text-center">
                            <div className="text-sm text-muted-foreground">
            ...
            {step === 3 &&
              securityLevel &&
              ["confidential", "privacy_preserving"].includes(
                securityLevel
              ) && (
                <div className="space-y-8">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Configure advanced privacy-preserving technologies
                    </p>
                  </div>
                  ...
                  {confidentialFeatures.length === 0 && (
                    <div className="text-center p-6 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800 rounded-lg">
                      <p className="text-amber-800 dark:text-amber-400 text-sm">
                        Please select confidential computing technologies to
                        continue.
                      </p>
                    </div>
                  )}
            ...
            {step === 4 && (
              <div className="space-y-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Select algorithms for your SDK. Recommended algorithms are
                    pre-selected, but you can modify the selection.
                  </p>
                  <div
                    className="flex items-center justify-center gap-2 mt-3 p-3 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg"
                    data-testid="text-deselect-message-algorithms"
                  >
                    <Lightbulb className="w-4 h-4 text-blue-600 dark:text-blue-400" />
                    <p className="text-sm text-blue-800 dark:text-blue-200">
                      <span className="font-medium">
                        ✓ All algorithms pre-selected for convenience.
                      </span>{" "}
                      Uncheck any you don't need.
                    </p>
                  </div>
                      ...
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-2">
                          ...
                          <Badge variant="secondary" className="text-xs">
                            {applicationTypes.length > 0
                              ? `Based on your ${applicationTypes.join(
                                  ", "
                                )} app with ${securityLevel} security`
                                ...
                                <div className="flex-1">
                                  <div className="flex items-center gap-2 mb-1">
                                    ...
                                    {algorithm.isPostQuantum && (
                                      <Badge
                                        variant="outline"
                                        className="text-xs bg-green-50 dark:bg-green-950/20 text-green-700 dark:text-green-400 border-green-300 dark:border-green-700"
                                      >
                                        Quantum-Safe
                                      </Badge>
                                    )}
                      ...
                      {algorithms.map((algorithm) => (
                        <Label
                          ...
                          className={`flex items-start space-x-3 border rounded-lg p-4 cursor-pointer hover:bg-secondary transition-colors ${
                            Array.isArray(recommendedAlgorithms) &&
                            recommendedAlgorithms.some(
                              (rec) => rec.id === algorithm.id
                            )
                            ...
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              {Array.isArray(recommendedAlgorithms) &&
                                recommendedAlgorithms.some(
                                  ...
                                  <Badge
                                    variant="secondary"
                                    className="text-xs bg-yellow-100 dark:bg-yellow-950/20 text-yellow-700 dark:text-yellow-400"
                                  >
                                    Recommended
                                  </Badge>
                                )}
                ...
                {selectedAlgorithms.length === 0 && (
                  <div className="text-center p-6 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800 rounded-lg">
                    <p className="text-amber-800 dark:text-amber-400 text-sm">
                      Please select at least one encryption algorithm to
                      continue.
                    </p>
                  </div>
                )}
            ...
            {step === 5 && (
              <div className="space-y-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Select all languages you need SDKs for
                  </p>
                </div>
                ...
                <div>
                  <div className="mb-4">
                    ...
                    <span className="text-muted-foreground text-sm font-normal">
                      <span className="font-medium text-blue-600 dark:text-blue-400">
                        ✓ All languages pre-selected.
                      </span>{" "}
                      Uncheck any languages you don't need SDKs for.
                    </span>
                  </div>
                  <div className="space-y-6">
                    {Object.entries(getLanguagesByCategory()).map(
            ...
            {step === 6 && (
              <div className="space-y-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Choose additional security and monitoring features
                  </p>
                </div>
            ...
            {step === 7 && (
              <div className="space-y-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Review your configuration before generating the SDK
                  </p>
                </div>
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <p>
                          ...
                          {applicationTypes
                            .map(
                              (id) =>
                                applicationTypeOptions.find((t) => t.id === id)
                                  ?.name
                            )
                            .join(", ")}
                        </p>
                        ...
                        <p>
                          ...
                          {
                            securityLevels.find((s) => s.id === securityLevel)
                              ?.name
                          }
                        </p>
                      </div>
                      ...
                      <div className="space-y-2 text-sm">
                        <p>
                          ...
                          {dataTypesSelected
                            .map(
                              (id) =>
                                dataTypeOptions.find((d) => d.id === id)?.name
                            )
                            .join(", ")}
                        </p>
                        <p>
                          ...
                          {complianceRequirements.length > 0
                            ? complianceRequirements
                                .map(
                                  (id) =>
                                    complianceStandards.find((c) => c.id === id)
                                      ?.name
                                )
                                .join(", ")
                            : "None specified"}
                    ...
                    <div>
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <p>
                          ...
                          {selectedLanguages
                            .map(
                              (id) => languages.find((l) => l.id === id)?.name
                            )
                            .filter(Boolean)
                            .join(", ")}
                        </p>
              ...
              <div className="text-center space-y-6 mt-8">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Your custom encryption SDK "{generatedSDK.name}" is ready
                    for download and integration.
                  </p>
                </div>
                  ...
                  onClick={async () => {
                    ...
                    try {
                      const response = await fetch(
                        `/api/sdks/${generatedSDK.id}/download`,
                        {
                          method: "GET",
