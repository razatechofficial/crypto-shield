...
export default function SdkWizard() {
  ...
  useEffect(() => {
    if (Array.isArray(recommendedAlgorithms) && recommendedAlgorithms.length > 0 && step === 3) {
      ...
      // Only auto-select if no algorithms are already selected (avoid overriding user choices)
      if (userSelectedAlgorithms.length === 0) {
        console.log('No algorithms selected yet, auto-selecting all recommended');
